!function(e){if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else{var o;"undefined"!=typeof window?o=window:"undefined"!=typeof global?o=global:"undefined"!=typeof self&&(o=self),o.CircularMigrationPlot=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
/*
...
module.exports = function(options) {
  ...
  d3.json(options.data, function(json) {
    ...
    var t = timeline(c, options.timeline);
    c.draw();
  });
};
...
module.exports = function(data, config) {
  ...
  if (config.mylayout.colors) {
    colors.range(config.mylayout.colors);
  }
  ...
  var mylayout = layout()
      ...
      .threshold(config.mylayout.threshold)
      .data(data)
      .year(config.now);

  if (config.mylayout.sortGroups) {
    mylayout.sortGroups(config.mylayout.sortGroups);
  }
  if (config.mylayout.sortSubgroups) {
    mylayout.sortSubgroups(config.mylayout.sortSubgroups);
  }
  if (config.mylayout.sortChors) {
    mylayout.sortChors(config.mylayout.sortChords);
  }

  // chord path generator
  var chordGenerator = chord()
  ...
  function groupInfo(d) {
    ...
    infoTimer = setTimeout(function() {
      ...
      var text = info.select('.text').selectAll('text')
        .data([
          data.names[d.id],
          'Net gain: ' + formatNumber(d.inflow),
          'Net loss: ' + formatNumber(d.outflow)
        ]);
  ...
  function rememberTheGroups() {
    previous.groups = mylayout.groups().reduce(function(sum, d) {
      sum[d.id] = d;
      return sum;
    }, {});
  }
  function rememberTheChords() {
    previous.chords = mylayout.chords().reduce(function(sum, d) {
  ...
  function draw(year, countries) {
    ...
    var group = element.selectAll(".group")
      .data(mylayout.groups, function(d) { return d.id; });
    group.enter()
      .append("g")
      .attr("class", "group");
    group
    ...
    groupTextGroup.exit()
      ...
      .attrTween("transform", function(d) {
        ...
        var region = mylayout.groups().filter(function(g) { return g.id === d.region });
    ...
    var chord = element.selectAll(".chord")
        .data(mylayout.chords, function(d) { return d.id; });
    chord.enter()
      .append("path")
      .attr("class", "chord")
...
},{"./chord":3,"./layout":5,"d3":7}],3:[function(_dereq_,module,exports){
...
},{"d3":7}],4:[function(_dereq_,module,exports){
...
var d3 = _dereq_('d3');
var countrymerge = _dereq_('./countrymerge');
...
},{"./countrymerge":4,"d3":7}],6:[function(_dereq_,module,exports){
...
},{"d3":7}],7:[function(_dereq_,module,exports){
!function() {
  var d3 = {
    version: "3.4.2"
  };
